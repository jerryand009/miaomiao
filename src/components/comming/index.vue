    ...
    export default {
      ...
      activated(){
        ...
        if (this.prevCity!=currentCity){
          this.axios.get('/api/movieComingList?cityId='+currentCity).then((res)=>{
            if (res.data.msg==="ok"){
